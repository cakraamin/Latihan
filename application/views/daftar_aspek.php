...
<table width="100%" border="0" class="table1">
	<tr>
		<th width="5%"><input type="checkbox" class="checkall" /></th><th width="8%">Edit</th><th width="35%">Nama Mapel</th><th>Aspek 1</th><th>Aspek 2</th><th>Aspek 3</th><th>Aspek 4</th><th>Aspek 5</th>
	</tr>
	<?php	
	if(count($kueri) > 0)
	{
