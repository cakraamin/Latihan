...
<table width="100%" border="0" class="table1">
	<tr>
		<th width="5%"><input type="checkbox" class="checkall" /></th><th width="10%">Edit</th><th><a href="<?=base_url().shorting_page($this->uri->uri_string(),$urs,"ta/".(($sort_order == 'asc') ? 'desc' : 'asc'))?>">Tahun Ajaran</a></th><th width="20%">Aktifkan</th>
	</tr>
	<?php
	if(count($kueri) > 0)
	{
